...
Accuracy Gain & +55.5pp $\pm$ 8.7pp & Oracle routing vs generalist ($n=3$) \\
...
\node[draw, rectangle, minimum width=3cm, minimum height=1cm] (before) {Single Generalist\\27.8\% accuracy};
\node[draw, rectangle, minimum width=3cm, minimum height=1cm, right=3cm of before] (after) {Specialized Population\\83.3\% accuracy};
\draw[->, thick] (before) -- node[above] {+55.5pp} (after);
\end{tikzpicture}
\end{center}
...
\begin{warning}
\textbf{+55.5pp $\pm$ 8.7pp at No Extra API Cost ($n=3$)!}
...
Accuracy Improvement & +55.5pp $\pm$ 8.7pp \\
ROI & Excellent \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{Massive practical benefit}: +55.5pp $\pm$ 8.7pp at no extra cost
...
\begin{itemize}
    \item +55.5pp $\pm$ 8.7pp accuracy ($n=3$) at no extra cost
