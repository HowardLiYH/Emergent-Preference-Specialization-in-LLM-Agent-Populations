...
Accuracy Gain & +64.2pp $\pm$ 2.3pp & Oracle routing vs generalist ($n=5$, 100\% ceiling) \\
...
\begin{warning}
\textbf{+64.2pp $\pm$ 2.3pp at No Extra API Cost ($n=5$, 100\% oracle ceiling)!}
...
\begin{enumerate}
    ...
    \item \textbf{Massive practical benefit}: +64.2pp $\pm$ 2.3pp at no extra cost (100\% oracle ceiling)
