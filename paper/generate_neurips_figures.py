...
def fig1_hero_mechanism():
    ...
    fig.text(0.365, 0.45, '100 gens', ha='center', fontsize=8, style='italic')
    fig.text(0.665, 0.45, '', ha='center', fontsize=8)
    ...
    plt.close()
    print("✓ Generated Figure 1: Hero Mechanism")


def fig2_specialization_emergence():
    """
    Figure 2: Specialization emergence over generations.
    Shows strategy levels accumulating over time.
    """
