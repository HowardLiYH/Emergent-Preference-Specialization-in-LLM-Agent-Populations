...
\begin{enumerate}
    ...
    \item \textbf{Latency tradeoffs}: Ensemble routing achieves +45.8pp but requires $R$ parallel calls. For latency-sensitive applications, confidence routing (+29.2pp) with single calls may be preferable.
\end{enumerate}
